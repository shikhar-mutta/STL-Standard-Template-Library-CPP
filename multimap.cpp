...
int main() {
    ...
    multimap<string,string> index = {
        {"cpp","vector"},{"cpp","map"},{"java","ArrayList"},
        {"cpp","set"},{"java","HashMap"}
    };
    ...
    while (git != index.end()) {
        ...
        for (auto it = s; it != e; ++it) cout << " " << it->second;
        cout << "\n";
        git = e;
    }
    ...
    // 7. Ranges (C++20)
    cout << "\n--- 7. Ranges ---\n";
    auto high = m | views::filter([](auto& p){ return p.first >= 2; });
    cout << "keys >= 2: ";
    ...
    cout << "unique keys: ";
    for (int k : unique_keys) cout << k << " "; cout << "\n";
