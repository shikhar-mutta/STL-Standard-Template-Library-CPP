...
int main() {
    ...
    cout << "um2 (unordered): ";
    for (auto& [k,v] : um2) cout << k << ":" << v << " "; cout << "\n";
    ...
    em.erase("b");
    cout << "after erase(b): "; for (auto& [k,v] : em) cout << k << ":" << v << " "; cout << "\n";
    em.erase(em.find("c"));
    cout << "after erase by iter: "; for (auto& [k,v] : em) cout << k << ":" << v << " "; cout << "\n";
    ...
    cout << "B (conflicting stays): "; for (auto& [k,v] : B) cout << k << ":" << v << " "; cout << "\n";
    ...
    grid[{0,0}]="origin"; grid[{1,2}]="right-down";
    ...
    cout << "score >= 90: ";
    for (auto [k,v] : high) cout << k << ":" << v << " "; cout << "\n";

    // 10. CP Patterns
    cout << "\n--- 10. CP Patterns ---\n";
    string ss = "programming";
    unordered_map<char,int> freq;
    for (char c : ss) freq[c]++;
    cout << "char freq in '" << ss << "': ";
    vector<pair<char,int>> fv(freq.begin(), freq.end());
    ranges::sort(fv, [](auto& a, auto& b){ return a.second < b.second; });
    for (auto [c,cnt] : fv) cout << c << ":" << cnt << " "; cout << "\n";
