...
int main() {
    ...
    array<int, 5> a4; a4.fill(7);

    cout << "a1 (zero):   "; for (int x : a1) cout << x << " "; cout << "\n";
    cout << "a2:          "; for (int x : a2) cout << x << " "; cout << "\n";
    cout << "a3 (CTAD):   "; for (int x : a3) cout << x << " "; cout << "\n";
    cout << "a4 (fill 7): "; for (int x : a4) cout << x << " "; cout << "\n";
    ...
    cout << "forward: "; for (int v : arr) cout << v << " "; cout << "\n";
    cout << "reverse: "; for (auto rit = arr.rbegin(); rit != arr.rend(); ++rit) cout << *rit << " "; cout << "\n";

    // 6. Algorithms (C++20 ranges)
    cout << "\n--- 6. Algorithms ---\n";
    array<int, 5> alg = {5, 3, 1, 4, 2};
    ranges::sort(alg);
    cout << "sorted:   "; for (int v : alg) cout << v << " "; cout << "\n";
    ranges::reverse(alg);
    cout << "reversed: "; for (int v : alg) cout << v << " "; cout << "\n";
    ...
    cout << "iota: "; for (int v : idx) cout << v << " "; cout << "\n";
    ...
    cout << "full:        "; for (int v : full_span) cout << v << " "; cout << "\n";
    cout << "subspan(2,4):"; for (int v : half)      cout << v << " "; cout << "\n";
    auto sum_span = [](span<const int> sp){ return reduce(sp.begin(), sp.end()); };
    ...
    cout << "powers of 2: "; for (int v : powers) cout << v << " "; cout << "\n";
    ...
    cout << "3x3 matrix:\n";
    for (auto& row : mat) { cout << "  "; for (int v : row) cout << v << " "; cout << "\n"; }
    auto [r0, r1, r2] = mat;
    cout << "row 0: "; for (int v : r0) cout << v << " "; cout << "\n";
